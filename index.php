...
<body class="bg-light">
    <div class="container bg-success text-center p-5">
        ...
        <h3 class="text-white fw-normal">Selamat Datang <span
                class="fw-bold"><?= ucwords(strtolower($_SESSION['nama'])) ?></span></h3>
    ...
    <div class="container border-start border-end border-bottom bg-light p-4">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" value="<?= strtoupper($_SESSION['nama']) ?>" readonly>
        </div>
        <div class="mb-3">
            <label class="form-label">Jurusan</label>
            <input type="text" class="form-control" value="<?= strtoupper($_SESSION['jurusan']) ?>" readonly>
        </div>
        <div class="mb-3">
            <label class="form-label">Asal Sekolah</label>
            <input type="text" class="form-control" value="<?= strtoupper($_SESSION['asal_sekolah']) ?>" readonly>
        </div>
        <div class="mb-3">
            <label class="form-label">Tanggal Daftar</label>
            <input type="text" class="form-control" value="<?= $_SESSION['tanggal_daftar'] ?>" readonly>
        </div>
